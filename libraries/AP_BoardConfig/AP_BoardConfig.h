...
public:
    ...
    enum px4_board_type {
        ...
        FMUV6_BOARD_HOLYBRO_6X_LSM6DSV32X = 44,
        FMUV6_BOARD_HOLYBRO_6X_LSM6DSK320X = 45,
        FMUV6_BOARD_HOLYBRO_6X_LSM6DSV32X_SPI2_ICM45686 = 46,
        FMUV6_BOARD_HOLYBRO_6X_LSM6DSK320X_SPI2_ICM45686 = 47,
        FMUV6_BOARD_HOLYBRO_6C = 48,
        FMUV6_BOARD_HOLYBRO_6C_LSM6DSV16X = 49,
        FMUV6_BOARD_HOLYBRO_6C_LSM6DSK320X = 50,
